...
main(int argc, char* argv[])
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_magic_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_version_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_cancel_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_finalize_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_get_poll_handles_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_receive_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_set_locality_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_transmit_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_id_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_struct_state_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
    };
