...
main(int argc, char* argv[])
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_setup_teardown (tss2_tcti_call_transmit_success_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_transmit_sgx_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_transmit_tcti_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_transmit_bad_sequence_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_receive_success_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_receive_sgx_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_receive_tcti_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_receive_bad_sequence_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_cancel_success_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_cancel_sgx_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_cancel_tcti_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_cancel_bad_sequence_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_get_poll_handles_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_set_locality_success_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_set_locality_sgx_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_set_locality_tcti_fail_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
        cmocka_unit_test_setup_teardown (tss2_tcti_call_set_locality_bad_sequence_test,
                                         tss2_tcti_struct_setup,
                                         tss2_tcti_struct_teardown),
    };
